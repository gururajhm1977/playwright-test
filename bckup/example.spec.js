...
test.describe('New Todo', () => {
  test('should allow me to add todo items @reg', async ({ page }) => {
    // Create 1st todo.
  ...
  test('should clear text input field when an item is added @reg', async ({ page }) => {
  ...
  test('should append new items to the bottom of the list @sanity', async ({ page }) => {
    // Create 3 items.
